...
from neat.genes import MutationRates, Genome
from neat.phenotypes import Phenotype
from neat.population import PopulationConfiguration, PopulationUpdate
from neat.speciatedPopulation import SpeciesConfiguration, SpeciatedPopulation
from neat.multiobjectivePopulation import MOConfiguration, MOPopulation
...
class WeightAgnosticPopulation(MOPopulation):
    ...
    def updatePopulation(self, update: PopulationUpdate) -> None:
        ...
        grouped_fitnesses = [np.mean(fitnesses[i:i + n]) for i in range(0, len(fitnesses), n)]
